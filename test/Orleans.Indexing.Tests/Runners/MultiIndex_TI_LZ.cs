...
namespace Orleans.Indexing.Tests
{
    ...
    public abstract class MultiIndex_TI_LZ: IndexingTestRunnerBase
    {
        ...
        {
            await base.TestIndexesWithOneDeactivation<IFT_Grain_UIUSNINS_TI_LZ_PK, FT_Props_UIUSNINS_TI_LZ_PK>();
        }

        [Fact, TestCategory("BVT"), TestCategory("Indexing")]
        public async Task Test_NFT_Grain_UIUSNINS_TI_LZ_PK()
        {
            await base.TestIndexesWithOneDeactivation<INFT_Grain_UIUSNINS_TI_LZ_PK, NFT_Props_UIUSNINS_TI_LZ_PK>();
        }

        [Fact, TestCategory("BVT"), TestCategory("Indexing")]
        public async Task Test_FT_Grain_UIUSNINS_TI_LZ_SB()
        {
            await base.TestIndexesWithOneDeactivation<IFT_Grain_UIUSNINS_TI_LZ_SB, FT_Props_UIUSNINS_TI_LZ_SB>();
        }

        [Fact, TestCategory("BVT"), TestCategory("Indexing")]
        public async Task Test_NFT_Grain_UIUSNINS_TI_LZ_SB()
        {
            await base.TestIndexesWithOneDeactivation<INFT_Grain_UIUSNINS_TI_LZ_SB, NFT_Props_UIUSNINS_TI_LZ_SB>();
        }
    }
}
