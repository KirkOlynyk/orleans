...
namespace Orleans.Indexing
{
    ...
    public class OrleansQueryResultStream<TIGrain> : IOrleansQueryResultStream<TIGrain> where TIGrain : IIndexableGrain
    {
        ...
        {
            return this._stream.OnNextAsync(item, token);
        }
        ...
        {
            return this._stream.SubscribeAsync(observer);
        }
        ...
        {
            return this._stream.SubscribeAsync(observer, token, filterFunc, filterData);
        }
    }
}
