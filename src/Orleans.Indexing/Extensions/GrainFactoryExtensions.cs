...
namespace Orleans.Indexing
{
    ...
    {
#if false //vv2 unused? overload of GetGrain without GrainTypeResolver param
        /// <summary>
        /// This method extends GrainFactory by adding a new GetGrain method that can get the runtime type of the grain interface along
        /// with its primary key, and return the grain casted to an interface that the given grainInterfaceType extends.
        /// 
